...
const animated_bgtexts = document.querySelectorAll('.animated-bg-text');
...
function getData() {
    ...
    excerpt.innerHTML = 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil, totam.'
